  ...
  config = function()
    ...
    for _, language in ipairs(js_based_languages) do
      dap.configurations[language] = {
        ...
        -- Debug nodejs processes (make sure to add --inspect when you run the process)
        {
          ...
          port = function()
            ...
            return coroutine.create(function()
              vim.ui.input({ prompt = "Enter Port: ", default = 3000 }, function(url)
        ...
        -- Debug vite applications (client side)
        {
          ...
          webRoot = vim.fn.getcwd() .. "/app",
          protocol = "inspector",
          cwd = "${workspaceFolder}",
          console = "integratedTerminal",
          internalConsoleOptions = "neverOpen",
          skipFiles = { "<node_internals>/**", "**/node_modules/**", "**/@fs/**", "**/@id/**", "**/@vite/**" },
          sourceMaps = true,
          sourceMapPathOverrides = {
            ["webpack:///./src/*"] = "${webRoot}/*",
            ["webpack:///src/*"] = "${webRoot}/*",
